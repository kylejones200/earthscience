...
def hantush_jacob(r: np.ndarray, t: np.ndarray, T: float, S: float,
                 Q: float, B: float) -> np.ndarray:
    """
...
def neuman_solution(r: np.ndarray, t: np.ndarray, T: float, S: float,
                   Sy: float, Q: float, b: float) -> np.ndarray:
    """
...
def pumping_test_analysis(drawdown: np.ndarray, distance: np.ndarray,
                         time: float, Q: float, aquifer_type: str = 'confined') -> Dict:
    """
