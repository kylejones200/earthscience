...
def alr(data: np.ndarray, denominator: Optional[int] = None) -> np.ndarray:
    """
...
def alr_inv(alr_data: np.ndarray, denominator: Optional[int] = None) -> np.ndarray:
    """
...
def ilr(data: np.ndarray, basis: Optional[np.ndarray] = None) -> np.ndarray:
    """
...
def ilr_inv(ilr_data: np.ndarray, basis: Optional[np.ndarray] = None) -> np.ndarray:
    """
