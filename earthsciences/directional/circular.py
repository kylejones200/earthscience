...
from ..utils.validation import validate_array, validate_angles
...
def rose_diagram_data(angles: np.ndarray,
                     n_bins: int = 16,
...
def watson_u2_test(angles1: np.ndarray,
                  angles2: np.ndarray,
                  degrees: bool = True) -> Dict:
    """
...
def kuiper_test(angles1: np.ndarray,
               angles2: np.ndarray,
               degrees: bool = True) -> Dict:
    """
...
def wheeler_watson_test(angles1: np.ndarray,
                       angles2: np.ndarray,
                       degrees: bool = True) -> Dict:
    """
