...
def fabric_tensor(orientations: np.ndarray,
...
def strain_ellipsoid(orientations_before: np.ndarray,
                    orientations_after: np.ndarray) -> Dict:
    """
...
def stereonet_contours(theta: np.ndarray,
                      phi: np.ndarray,
                      grid_size: int = 50,
...
def pole_to_plane(strike: float, dip: float,
