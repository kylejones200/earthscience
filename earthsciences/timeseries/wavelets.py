...
def cwt(data: np.ndarray,
        wavelet: str = 'morl',
        scales: Optional[np.ndarray] = None,
        sampling_period: float = 1.0) -> Dict:
    """
...
def dwt(data: np.ndarray,
        wavelet: str = 'db4',
        level: Optional[int] = None,
        mode: str = 'symmetric') -> Dict:
    """
...
def idwt(coeffs: Union[Dict, list],
         wavelet: str = 'db4',
...
def wavelet_coherence(x: np.ndarray,
                      y: np.ndarray,
                      wavelet: str = 'morl',
                      scales: Optional[np.ndarray] = None,
                      sampling_period: float = 1.0) -> Dict:
...
def wavelet_power(data: np.ndarray,
                  wavelet: str = 'morl',
                  scales: Optional[np.ndarray] = None,
                  sampling_period: float = 1.0) -> Dict:
    """
...
def wavelet_denoise(data: np.ndarray,
                    wavelet: str = 'db4',
                    level: Optional[int] = None,
