...
def mann_kendall_test(data: np.ndarray,
...
def binary_segmentation(data: np.ndarray,
                       min_size: int = 10,
                       max_splits: int = 10) -> List[int]:
    """
...
def breakpoint_detection_bayesian(data: np.ndarray,
                                  prior_prob: float = 0.01) -> Dict:
    """
...
def trend_decomposition_stl(data: np.ndarray,
                           period: int,
                           seasonal: int = 7) -> Dict:
    """
