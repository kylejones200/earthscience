...
def resample(data: np.ndarray, original_rate: float, target_rate: float) -> np.ndarray:
    """
...
def autocorrelation(data: np.ndarray, max_lag: int | None = None) -> tuple[np.ndarray, np.ndarray]:
    """
