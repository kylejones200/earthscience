...
def descriptive_stats(data: Union[list, np.ndarray], 
                     remove_nan: bool = True) -> Dict[str, float]:
    """
...
def percentiles(data: Union[list, np.ndarray], 
                q: Union[float, list] = [25, 50, 75],
                remove_nan: bool = True) -> Union[float, np.ndarray]:
    """
...
def mode_estimate(data: Union[list, np.ndarray], 
                  method: str = 'kernel',
    ...
    match method:
        ...
        case _:
            raise ValueError(
                f"Unknown method '{method}'. Valid options: 'max', 'kde'"
            )


def skewness(data: Union[list, np.ndarray], 
...
def kurtosis(data: Union[list, np.ndarray],
             remove_nan: bool = True,
...
def z_score(data: Union[list, np.ndarray],
...
def coefficient_of_variation(data: Union[list, np.ndarray],
                             remove_nan: bool = True) -> float:
    """
