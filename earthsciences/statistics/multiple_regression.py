...
def elastic_net_regression(X: np.ndarray, y: np.ndarray,
                           alpha: float = 1.0,
                           l1_ratio: float = 0.5,
                           cv: int = 5,
                           auto_alpha: bool = False) -> Dict:
...
def polynomial_regression_multivariate(X: np.ndarray, y: np.ndarray,
                                      degree: int = 2,
                                      interaction_only: bool = False) -> Dict:
    """
...
def vif_analysis(X: np.ndarray, feature_names: Optional[List[str]] = None) -> Dict:
    """
