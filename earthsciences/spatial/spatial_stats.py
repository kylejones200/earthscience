...
def spatial_weights_matrix(coordinates: np.ndarray,
...
def gearys_c(values: np.ndarray,
            coordinates: np.ndarray,
            weights: Optional[np.ndarray] = None) -> Dict:
    """
...
def local_morans_i(values: np.ndarray,
                  coordinates: np.ndarray,
                  weights: Optional[np.ndarray] = None) -> Dict:
    """
...
def getis_ord_g(values: np.ndarray,
               coordinates: np.ndarray,
               weights: Optional[np.ndarray] = None) -> Dict:
    """
...
def spatial_correlogram(values: np.ndarray,
                       coordinates: np.ndarray,
                       n_lags: int = 10,
...
def semivariogram(values: np.ndarray,
                 coordinates: np.ndarray,
                 n_lags: int = 15,
    ...
    lag_dist, gamma, _ = compute_variogram(x, y, values, n_lags=n_lags, 
