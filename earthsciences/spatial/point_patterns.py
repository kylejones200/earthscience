...
def nearest_neighbor_distance(x: np.ndarray,
                              y: np.ndarray,
                              k: int = 1) -> np.ndarray:
    """
...
def ripley_k(x: np.ndarray,
            y: np.ndarray,
            distances: np.ndarray,
            area: Optional[float] = None) -> np.ndarray:
    """
...
def point_density(x: np.ndarray,
                 y: np.ndarray,
                 grid_x: np.ndarray,
                 grid_y: np.ndarray,
...
def clark_evans_statistic(x: np.ndarray,
                          y: np.ndarray,
...
def f_function(x: np.ndarray,
              y: np.ndarray,
              distances: np.ndarray,
              n_random: int = 100) -> np.ndarray:
    """
