...
import pytest
import numpy as np
from earthsciences.spatial import kriging, variogram
...
class TestKrigingVariance:
    ...
    def test_variance_output(self):
        ...
        estimate = kriging.ordinary_kriging(
            x, y, values, grid_x, grid_y, variogram_func
        )
...
class TestCrossValidation:
    ...
    def test_leave_one_out(self):
        ...
        pytest.skip("cross_validate function not yet implemented")
        np.random.seed(42)
