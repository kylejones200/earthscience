...
class TestGaussianMixture:
    ...
    def test_basic_functionality(self):
        """Test GMM clustering."""
        np.random.seed(42)
        X = np.vstack([np.random.randn(40, 2), np.random.randn(40, 2) + 3])
...
class TestClusterValidation:
    ...
    def test_calinski_harabasz_score(self):
        ...
        np.random.seed(42)
        X = np.vstack([np.random.randn(25, 2), np.random.randn(25, 2) + 4])
...
class TestElbowMethod:
    ...
    def test_find_optimal_k(self):
        ...
        np.random.seed(42)
        X = np.vstack(
            [np.random.randn(30, 2), np.random.randn(30, 2) + 5, np.random.randn(30, 2) + 10]
        )
