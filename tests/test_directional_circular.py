...
class TestRayleighTest:
    ...
    def test_returns_dict(self, sample_angles):
        ...
        expected_keys = ['statistic', 'p_value', 'mean_resultant_length',
                        'mean_direction', 'significant']
...
class TestRoseDiagramData:
    ...
    def test_returns_dict(self, sample_angles):
        ...
        expected_keys = ['bin_centers_rad', 'bin_centers_deg', 'bin_width',
                        'counts', 'frequencies', 'n_bins']
